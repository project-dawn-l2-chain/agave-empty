...
impl From<DeserializableVersionedBank> for BankFieldsToDeserialize {
    fn from(dvb: DeserializableVersionedBank) -> Self {
        BankFieldsToDeserialize {
            ...
            projectdawn_config: None, // populated from ExtraFieldsToDeserialize
        }
    }
}
...
struct ExtraFieldsToDeserialize {
    ...
    #[serde(deserialize_with = "default_on_eof")]
    projectdawn_config: Option<ProjectDawnConfig>,
}
...
pub struct ExtraFieldsToSerialize<'a> {
    ...
    pub projectdawn_config: Option<ProjectDawnConfig>,
}
    ...
    R: Read,
{
    ...
    bank_fields.projectdawn_config = projectdawn_config;
...
impl Serialize for SerializableBankAndStorage<'_> {
        ...
        S: serde::ser::Serializer,
    {
        ...
        let projectdawn_config = bank_fields.projectdawn_config.clone();
        let bank_fields_to_serialize = (
            ...
            ExtraFieldsToSerialize {
                ...
                versioned_epoch_stakes,
                accounts_lt_hash,
                projectdawn_config: Some(projectdawn_config),
            },
        );
